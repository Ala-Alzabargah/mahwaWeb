...
if (displayName.equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 'C', 3))) {
    titleCondition = true
...
if (message.equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 'C', 4))) {
...
if (HDIcons.equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 'C', 5))) {
    HDCondition = true
...
if (offlineIcon.equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 'C', 6))) {
...
if (watchOnTVIcon.equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 'C', 7))) {
    TVCondition = true
...
if (joinNowButton.equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 'C', 8))) {
    CTA2Condition = true
...
if (loginButton.equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 'C', 9))) {
    CTA1Condition = true
