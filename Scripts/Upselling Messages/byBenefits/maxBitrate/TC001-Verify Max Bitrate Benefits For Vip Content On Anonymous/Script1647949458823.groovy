...
if (WebUI.getText(findTestObject('Object Repository/upSelling/displayName')).equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 
    ...
    new Common().updateUpsellResultSheet('Title', GlobalVariable.Benefits,new Common().getUpsellTitle(GlobalVariable.Benefits, 'L', 13), WebUI.getText(findTestObject(
...
if (WebUI.getText(findTestObject('Object Repository/upSelling/message')).equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 
    ...
    new Common().updateUpsellResultSheet('Message',GlobalVariable.Benefits, new Common().getUpsellTitle(GlobalVariable.Benefits, 'L', 14), WebUI.getText(findTestObject(
...
//check HD text
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/HDIcons'), 'alt').equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 
        'L', 15))) {
    HDCondition = true
    ...
    new Common().updateUpsellResultSheet('HD Icon',GlobalVariable.Benefits, new Common().getUpsellTitle(GlobalVariable.Benefits, 'L', 15), WebUI.getAttribute(findTestObject(
...
//check offline text
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/offlineIcon'), 'alt').equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 
        'L', 16))) {
    ...
    new Common().updateUpsellResultSheet('Offline download Icon',GlobalVariable.Benefits, new Common().getUpsellTitle(GlobalVariable.Benefits, 'L', 16), WebUI.getAttribute(
...
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/watchOnTVIcon'), 'alt').equals(new Common().getUpsellTitle(
    ...
    new Common().updateUpsellResultSheet('Watch on TV Icon',GlobalVariable.Benefits, new Common().getUpsellTitle(GlobalVariable.Benefits, 'L', 17), WebUI.getAttribute(
...
if (WebUI.getText(findTestObject('Object Repository/upSelling/joinNowButton')).equals(new Common().getUpsellTitle(GlobalVariable.Benefits,
	...
	new Common().updateUpsellResultSheet('CTA1',GlobalVariable.Benefits, new Common().getUpsellTitle(GlobalVariable.Benefits, 'L', 18), WebUI.getText(findTestObject(
...
if (WebUI.getText(findTestObject('Object Repository/upSelling/loginButton')).equals(new Common().getUpsellTitle(GlobalVariable.Benefits, 
    ...
    new Common().updateUpsellResultSheet('CTA2',GlobalVariable.Benefits, new Common().getUpsellTitle(GlobalVariable.Benefits, 'L', 19), WebUI.getText(findTestObject(
...
if (WebUI.verifyImagePresent(findTestObject('Object Repository/upSelling/Images/Series/desktopUpsellPlayer_upsellImg'),FailureHandling.CONTINUE_ON_FAILURE)) {
	...
	new Common().updateUpsellResultSheet('Display Image',GlobalVariable.Benefits, "check screenshots", "check screenshots", count)
...
if(WebUI.verifyImagePresent(findTestObject('Object Repository/upSelling/Images/Series/hdIcon'),FailureHandling.CONTINUE_ON_FAILURE)){
	...
	new Common().updateUpsellResultSheet('HD Icon', GlobalVariable.Benefits,"check screenshots", "check screenshots", count)
...
if(WebUI.verifyImagePresent(findTestObject('Object Repository/upSelling/Images/Series/offlineDownloadIcon'),FailureHandling.CONTINUE_ON_FAILURE)){
	...
	new Common().updateUpsellResultSheet('offline Icon',GlobalVariable.Benefits, "check screenshots", "check screenshots", count)
...
if(WebUI.verifyImagePresent(findTestObject('Object Repository/upSelling/Images/Series/watchOnTVIcon'),FailureHandling.CONTINUE_ON_FAILURE)){
	...
	new Common().updateUpsellResultSheet('Watch on TV Icon',GlobalVariable.Benefits, "check screenshots", "check screenshots", count)
