...
for (int j = 0; j < 3; j++) {
    ...
    if (!((GlobalVariable.catalogMap['displayName']).equals(CustomKeywords.'sample.upsellingMessages.getData'(3, 
        ...
        CustomKeywords.'sample.upsellingMessages.updateUpsellResultSheet'(CustomKeywords.'sample.upsellingMessages.getData'(
                3, 'B'), 'byContent', CustomKeywords.'sample.upsellingMessages.getData'(3, column), GlobalVariable.catalogMap['displayName'])

        KeywordUtil.markFailed((('Title not matche Expected :' + CustomKeywords.'sample.upsellingMessages.getData'(3, column)) + 
            'Actual :') + (GlobalVariable.catalogMap['displayName']))
    }
