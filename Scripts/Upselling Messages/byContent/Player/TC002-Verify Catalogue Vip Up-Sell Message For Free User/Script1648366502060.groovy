...
WebUI.navigateToUrl('https://shahid.mbc.net/ar/series/%D8%B9%D8%B1%D9%88%D8%B3-%D8%A8%D9%8A%D8%B1%D9%88%D8%AA-%D8%A7%D9%84%D9%85%D9%88%D8%B3%D9%85-3-%D8%A7%D9%84%D8%AD%D9%84%D9%82%D8%A9-26/episode-935808')
...
if (WebUI.getText(findTestObject('Object Repository/upSelling/displayName')).equals(new Common().getUpsellTitle(GlobalVariable.Content, 
    ...
    new Common().updateUpsellResultSheet('Title',GlobalVariable.Content, new Common().getUpsellTitle(GlobalVariable.Content, 'C', 3), WebUI.getText(findTestObject(
...
if (WebUI.getText(findTestObject('Object Repository/upSelling/message')).equals(new Common().getUpsellTitle(GlobalVariable.Content, 
    ...
    new Common().updateUpsellResultSheet('Message',GlobalVariable.Content, new Common().getUpsellTitle(GlobalVariable.Content, 'C', 4), WebUI.getText(findTestObject(
...
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/HDIcons'), 'alt').equals(new Common().getUpsellTitle(GlobalVariable.Content, 
    ...
    new Common().updateUpsellResultSheet('HD Icon', GlobalVariable.Content,new Common().getUpsellTitle(GlobalVariable.Content, 'C', 6), WebUI.getAttribute(findTestObject(
...
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/offlineIcon'), 'alt').equals(new Common().getUpsellTitle(GlobalVariable.Content, 
    ...
    new Common().updateUpsellResultSheet('Offline download Icon',GlobalVariable.Content, new Common().getUpsellTitle(GlobalVariable.Content, 'C', 7), WebUI.getAttribute(
...
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/watchOnTVIcon'), 'alt').equals(new Common().getUpsellTitle(
        GlobalVariable.Content, 'C', 8))) {
    TVCondition = true
	KeywordUtil.markPassed("watch on TV text matched")
} else {
    TVCondition = false
	KeywordUtil.markFailed("Watch on TV text not matched")
    new Common().updateUpsellResultSheet('Watch on TV Icon',GlobalVariable.Content, new Common().getUpsellTitle(GlobalVariable.Content, 'C', 8), WebUI.getAttribute(
...
if (WebUI.getText(findTestObject('Object Repository/upSelling/joinNowButton')).equals(new Common().getUpsellTitle(GlobalVariable.Content,
	...
	new Common().updateUpsellResultSheet('CTA1',GlobalVariable.Content, new Common().getUpsellTitle(GlobalVariable.Content, 'C', 9), WebUI.getText(findTestObject(
...
if (WebUI.getText(findTestObject('Object Repository/upSelling/loginButton')).equals(new Common().getUpsellTitle(GlobalVariable.Content, 
    ...
    new Common().updateUpsellResultSheet('CTA2', GlobalVariable.Content,new Common().getUpsellTitle(GlobalVariable.Content, 'C', 11), WebUI.getText(findTestObject(
