...
firstSeasonImage = WebUI.getAttribute(findTestObject('Object Repository/Show Pages/heroBannerImage'), 'class')
...
secondSeasonImage = WebUI.getAttribute(findTestObject('Object Repository/Show Pages/heroBannerImage'), 'class')
