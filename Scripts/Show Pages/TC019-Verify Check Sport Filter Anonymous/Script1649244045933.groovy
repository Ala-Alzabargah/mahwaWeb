...
//new Common().ScrollUntilElementPresent('Object Repository/Show Pages/filter')
WebUI.click(findTestObject('Object Repository/Show Pages/filter'))

WebUI.verifyElementPresent(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/allFilter'), 3)

WebUI.verifyElementPresent(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/liveFilter'), 3)
...
WebUI.verifyElementPresent(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/replayEpisode'),5)
