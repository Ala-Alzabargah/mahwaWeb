...
def searchValuesList = ['joelle unfiltered', 'Ahmed Notre-Dame', 'The Kings Cup HD']
	...
	for (int y = 0; y < searchValuesList.size(); y++) {
		...
		WebUI.verifyElementPresent(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/relatedTab'),  5, FailureHandling.CONTINUE_ON_FAILURE)
		...
		if (y == 0) {
			WebUI.click(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/episodesTab'))
				...
				WebUI.verifyElementNotPresent(findTestObject('Object Repository/Show Pages/freeEpisodesToggle'), 4)
			}

			
			WebUI.click(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/clipsTab'))
			WebUI.delay(1)
			WebUI.verifyElementPresent(findTestObject('Object Repository/Show Pages/episodesAndClips'), 4)
		...
		new Common().ScrollUntilElementPresent(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/relatedTab')
		WebUI.verifyElementPresent(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/relatedTab'), 5, FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.click(findTestObject(('Object Repository/Show Pages/' + GlobalVariable.objLanguage) + '/relatedTab'), FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.delay(1)
		WebUI.verifyElementPresent(findTestObject('Object Repository/Show Pages/relatedTabData'), 4, FailureHandling.CONTINUE_ON_FAILURE)
