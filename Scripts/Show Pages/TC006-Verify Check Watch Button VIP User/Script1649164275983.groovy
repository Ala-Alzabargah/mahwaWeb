...
def searchValuesList = 'Rashash'
   ...
   new Common().checkLanguage()
	...
	new Common().search(searchValuesList)
		...
		WebUI.waitForElementVisible(findTestObject('Object Repository/Show Pages/'+GlobalVariable.objLanguage+'/watchNowbuttonShowpages'),5)
		WebUI.click(findTestObject('Object Repository/Show Pages/'+GlobalVariable.objLanguage+'/watchNowbuttonShowpages'))
		WebUI.waitForPageLoad(3)
		WebUI.verifyElementNotPresent(findTestObject(('Object Repository/LandingPages/' + GlobalVariable.objLanguage) + '/joinNowbutton'), 5)
