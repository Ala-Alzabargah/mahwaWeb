...
for (int i = 1; i <= lastRow; i++) {
	...
	WebUI.waitForElementPresent(findTestObject('Object Repository/Player/shareIcon'), 4)
	WebUI.click(findTestObject('Object Repository/Player/shareIcon'))
	WebUI.delay(2)
	WebUI.verifyElementPresent(findTestObject('Object Repository/VideoPlaybackScreen/Share Options/facebookButton'), 3)
	WebUI.verifyElementPresent(findTestObject('Object Repository/VideoPlaybackScreen/Share Options/twitterButton'), 3)
	WebUI.verifyElementPresent(findTestObject('Object Repository/Player/copyLinkIcon'), 3)
	if(WebUI.getText(findTestObject('Object Repository/Player/copyLinkText'))=='') {
		KeywordUtil.markFailed('Copy Link Text is empty')
	}
	WebUI.verifyElementPresent(findTestObject('Object Repository/Player/closeButton'), 3)
	WebUI.verifyElementPresent(findTestObject('Object Repository/Player/' + GlobalVariable.objLanguage + '/copyUrl'), 3)
	WebUI.click(findTestObject('Object Repository/Player/closeButton'))
