...
for (int i = 1; i <= lastRow; i++) {
	...
	WebUI.verifyElementVisible(findTestObject('Object Repository/Player/episodesList'))
	WebUI.waitForElementPresent(findTestObject('Object Repository/Player/fullScreenButton'), 4)
	WebUI.click(findTestObject('Object Repository/Player/fullScreenButton'))
	WebUI.delay(2)
