...
WebUI.click(findTestObject('Object Repository/paymentThreeLanguages/'+GlobalVariable.objLanguage+'/imagineTextChooseYourPackagePage'))
//Mobile.swipe(0, 600, 0, 0)
WebUI.click(findTestObject('Object Repository/subscribtionPage/joinNowButton'))
WebUI.delay(5)


//upgrade your package page
WebUI.verifyElementPresent(findTestObject('Object Repository/paymentThreeLanguages/'+GlobalVariable.objLanguage+'/imagineText'), 3)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/paymentThreeLanguages/'+GlobalVariable.objLanguage+'/imagineTextOnShahid'), 3)
...
WebUI.verifyElementPresent(findTestObject('upgrdeYourPackagePage/ultimatePrice'), 3)
...
WebUI.click(findTestObject('Object Repository/madaCreditCard'))

//credit card page 
WebUI.verifyElementPresent(findTestObject('Object Repository/paymentThreeLanguages/'+GlobalVariable.objLanguage+'/oneStepForUnlimitedEntertainmentText'), 3)
