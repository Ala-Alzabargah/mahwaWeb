...
WebUI.delay(2)
WebUI.setText(findTestObject('Object Repository/CCtexts/expiryDate'), '0788')
WebUI.switchToDefaultContent()
WebUI.waitForPageLoad(6)
...
new Common().checkLanguage()
WebUI.delay(15)
WebUI.navigateToUrl(GlobalVariable.assetLink+GlobalVariable.objLanguage+'/home')
...
WebUI.click(findTestObject('Object Repository/paymentThreeLanguages/'+GlobalVariable.objLanguage+'/chooseSportPackageButton'))
...
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/paymentThreeLanguages/'+GlobalVariable.objLanguage+'/upgradeButton'))
WebUI.delay(3)
new Common().checkLanguage()
