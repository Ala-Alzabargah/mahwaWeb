...
new Common().login(GlobalVariable.SportUser, GlobalVariable.SportUserPassword)
...
WebUI.verifyElementPresent(findTestObject(('Object Repository/' + GlobalVariable.objLanguage) + '/Settings Screen/Account Settings Screen/upsellTitle-Sport'), 
    2)
