...
WebUI.setText(findTestObject('Object Repository/LoginScreen/usernameField'), GlobalVariable.VipUser)
...
//WebUI.verifyElementAttributeValue(findTestObject('Object Repository/LoginScreen/usernameField'), 'value', GlobalVariable.VipUser, 3)
