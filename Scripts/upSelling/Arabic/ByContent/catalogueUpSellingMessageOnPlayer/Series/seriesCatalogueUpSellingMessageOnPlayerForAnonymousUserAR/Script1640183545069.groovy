...
import cucumber.api.java.en_scouse.Wun
...
String excelLoginButton = new Shahid().getUpsellTitle(GlobalVariable.Content, 'C', 10)
...
if (loginButton.equals(excelLoginButton)) {
    ...
    new Shahid().updateUpsellResultSheet('CTA2', GlobalVariable.Content, excelLoginButton, loginButton, count)
