...
//Check Title
if (WebUI.getText(findTestObject('Object Repository/upSelling/displayName')).equals(new Shahid().getUpsellTitle(GlobalVariable.Benefits, 
        'L', 4))) {
    titleCondition = true
    ...
    new Shahid().updateResultSheet('Title', new Shahid().getUpsellTitle(GlobalVariable.Benefits, 'L', 4), WebUI.getText(findTestObject(
...
//Check Message
if (WebUI.getText(findTestObject('Object Repository/upSelling/message')).equals(new Shahid().getUpsellTitle(GlobalVariable.Benefits, 
        'L', 5))) {
    ...
    new Shahid().updateResultSheet('Message', new Shahid().getUpsellTitle(GlobalVariable.Benefits, 'L', 5), WebUI.getText(findTestObject(
...
//check HD text
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/HDIcons'), 'alt').equals(new Shahid().getUpsellTitle(GlobalVariable.Benefits, 
        'L', 6))) {
    HDCondition = true
    ...
    new Shahid().updateResultSheet('HD Icon', new Shahid().getUpsellTitle(GlobalVariable.Benefits, 'L', 6), WebUI.getAttribute(findTestObject(
...
//check offline text
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/offlineIcon'), 'alt').equals(new Shahid().getUpsellTitle(GlobalVariable.Benefits, 
        'L', 7))) {
    ...
    new Shahid().updateResultSheet('Offline download Icon', new Shahid().getUpsellTitle(GlobalVariable.Benefits, 'L', 7), WebUI.getAttribute(
...
if (WebUI.getAttribute(findTestObject('Object Repository/upSelling/watchOnTVIcon'), 'alt').equals(new Shahid().getUpsellTitle(
    ...
    new Shahid().updateResultSheet('Watch on TV Icon', new Shahid().getUpsellTitle(GlobalVariable.Benefits, 'L', 8), WebUI.getAttribute(
...
//Check CTA1
if (WebUI.getText(findTestObject('Object Repository/upSelling/joinNowButton')).equals(new Shahid().getUpsellTitle(GlobalVariable.Benefits,
		'L', 9))) {
	CTA2Condition = true
	...
	new Shahid().updateResultSheet('CTA1', new Shahid().getUpsellTitle(GlobalVariable.Benefits, 'L', 9), WebUI.getText(findTestObject(
...
//check CTA2
if (WebUI.getText(findTestObject('Object Repository/upSelling/loginButton')).equals(new Shahid().getUpsellTitle(GlobalVariable.Benefits, 
        'L', 10))) {
    CTA1Condition = true
    ...
    new Shahid().updateResultSheet('CTA2', new Shahid().getUpsellTitle(GlobalVariable.Benefits, 'L', 10), WebUI.getText(findTestObject(
